        ...
        <div class="flex content-start justify-around">
            <div class="mt-4 col-3 flex-col">
                ...
                <div class="text-center mt-2">
                    <h3 class="text-lg text-slate-700 font-bold leading-normal mb-1">{{$userMe->name}}</h3>
                    <h6 class="text-slate-700 leading-normal mb-1">{{$userMe->name}}</h6>
            ...
            <div class="col-9 col-md-9 ps-4 h-screen">
                ...
                <div class="messenger">
                    ...
                    <div class="messenger-messagingView">
                        ...
                        {{-- Send Message Form --}}                      
                        @if(!session('me_id') || session('me_id')==auth()->id())
